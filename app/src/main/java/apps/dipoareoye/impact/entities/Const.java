...
public final class Const {
    ...
    public static final String MEDIA_DETAILS_KEY = "media_details";
    public static final String MEDIA_SIZES_KEY = "sizes";
    public static final String MEDA_TWO_THIRD = "vw_two_third_thumbnail";
